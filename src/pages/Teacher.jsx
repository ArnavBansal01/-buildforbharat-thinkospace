  ...
  const LessonView = memo(({ lesson, videoId }) => {
    ...
    return (
      <div className="bg-white dark:bg-gray-900 p-6 rounded-[2rem] border-2 border-gray-100 dark:border-gray-800 shadow-xl mb-12 transition-all">
        <h1 className="text-2xl font-black mb-4 text-gray-900 dark:text-white tracking-tight">
          {lesson.title}
        </h1>
        ...
        {isChatOpen && (
          <div className="fixed bottom-28 right-8 w-[350px] md:w-[400px] h-[550px] bg-white dark:bg-gray-900 border-2 border-blue-50 dark:border-gray-800 rounded-[2rem] shadow-2xl flex flex-col overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-4 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 flex gap-2">
              <input
className="flex-1 text-sm border-2 rounded-xl px-4 py-3 focus:border-black outline-none transition-colors dark:bg-gray-800 dark:border-gray-700 text-black dark:text-white font-medium"                placeholder="Ask a doubt..."
                value={chatInput}
